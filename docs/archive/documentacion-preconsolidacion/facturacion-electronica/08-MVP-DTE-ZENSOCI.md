...
El MVP del DTE cubre exactamente lo necesario para operar legalmente desde el primer día:
...
Esto significa que el campo `receptor` del DTE tiene:
...
Los siguientes supuestos aplican para el MVP y deben validarse con fuentes oficiales antes de
implementar:

| Supuesto | Base | Estado |
|---|---|---|
| Todos los ítems del menú son Bienes (CAT-011: código 1) | Lógico para restaurante vegano | PENDIENTE DE VALIDAR CON FUENTE OFICIAL |
