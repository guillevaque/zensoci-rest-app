...
const FALLBACK_USERS = [
  { id: 1, name: 'Andrés',  role: 'Mesero',  color: '#D86835' },
  { id: 2, name: 'Marisol', role: 'Cajera',  color: '#3C6030' },
  { id: 3, name: 'Sofía',   role: 'Mesera',  color: '#5B8C3A' },
];
      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8 }}>
          {users.map(u => (
            ...
            >
              <span style={{ width: 30, height: 30, borderRadius: 999, background: avatarColor(u), color: '#fff', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--zs-font-display)', fontSize: 14, flexShrink: 0 }}>
                {u.name[0].toUpperCase()}
              </span>
              <span>
                <span style={{ display: 'block' }}>{u.name}</span>
                <span style={{ fontWeight: 400, color: 'var(--zs-mute)', fontSize: 10 }}>{u.role}</span>
              </span>
            </button>
          ))}
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8 }}>
          ...
          <button onClick={() => tap('C')} style={{ background: 'transparent', border: 'none', borderRadius: 14, padding: '14px 0', cursor: 'pointer', fontFamily: 'var(--zs-font-mono)', fontWeight: 700, fontSize: 13, color: 'var(--zs-mute)', minHeight: 54 }}>
            Borrar
          </button>
          ...
          onMouseLeave={e => e.currentTarget.style.background = '#fff'}
          >0</button>
          <button onClick={() => tap('⌫')} style={{ background: 'transparent', border: 'none', borderRadius: 14, padding: '14px 0', cursor: 'pointer', fontFamily: 'var(--zs-font-mono)', fontWeight: 700, fontSize: 18, color: 'var(--zs-mute)', minHeight: 54 }}>
            ⌫
          </button>
        </div>
      </div>
